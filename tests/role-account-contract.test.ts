...
test('user-management surfaces expose exact roles and the exact-role referral ledger', () => {
  ...
  assert.match(referrals, /Referral history - who invited whom, scoped to the exact client, driver or artisan account/)
  assert.match(referrals, /No referrals match this view/)
